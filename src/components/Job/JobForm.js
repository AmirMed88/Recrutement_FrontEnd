...
import { Button, Chip, FormControl, Input, InputAdornment, InputLabel, MenuItem, OutlinedInput, Paper, Select } from "@material-ui/core";
    ...
    <>
      ...
      <div>
        <Paper style={paperStyle}>
          ...
          <Button variant="contained" style={{ backgroundColor: "black", color: "white" }} type="button" onClick={handleClick}>
            ...
            <Collapse in={expanded} timeout="auto" unmountOnExit>
              <div style={{ postion: "relative", justifyContent: "flex", backgroundcolor: "black" }}  >
                <Fragment>
                  ...
                  <h5 className='am' style={{ postion: "relative", justifyContent: "center", color: "black", fontFamily: 'cursive' }}>Add a Job/Internship</h5>
                      ...
                      onChange={(event) => { setCompany(event.target.value) }} /></div>
                                ...
                                {selectedImage && (
                                  ...
                                  <button onClick={()=>setSelectedImage(null)}>Remove</button>
                                    ...
                                    <input type="file"  id="file" name="ImageStyle" onChange={(event) => {
              ...
              <div style={{ marginTop: 50 }} >
                <Fragment >
                  ...
                  {/* <Button type="file" onClick={Jobhandler}>submmmit</Button>
              ...
              <div style={{ marginTop: "3rem" }} >
                <Button type='submit' variant="contained" style={{ backgroundColor: 'black', color: "white" }} onClick={Jobhandler} fullWidth>Submit</Button>
              </div>
